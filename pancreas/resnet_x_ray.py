...
def trainandtest():
    ...
    # # 모델 저장
    torch.save(model.state_dict(), "covid_resnet_selected.pth")

    # 테스트 데이터로 예측 수행
    model.load_state_dict(torch.load("covid_resnet_selected.pth"))
    model.eval()
...
if __name__ == '__main__':
    data_dir = "D:/data/diffusion/COVID_19_Radiography_Dataset"
