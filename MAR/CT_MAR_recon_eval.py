...
if __name__=="__main__":
    ...
    parser.add_argument('--input_path', default='D:/data/CT_MAR/Phase3_test/phase3_final_test_data/Syndiff_sr_29/body_sino_raw', type=str)
    parser.add_argument('--save_path', default='D:\data\CT_MAR\CT_MAR_raw_version\CT_MAR\Train\Ssino', type=str)
    parser.add_argument('--anatomy', default='o', type=str)
    ...
    inp_path = glob.glob(args.input_path+'/*.raw')
    print(inp_path)
    n=0
    for inp_file in inp_path:
        print(inp_file)
