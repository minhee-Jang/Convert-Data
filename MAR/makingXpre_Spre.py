...
if __name__=="__main__":
    ...
    parser.add_argument('--input_path', default='D:\data\CT_MAR\CT_MAR_raw_version\CT_MAR\Test\s_res', type=str)
    parser.add_argument('--save_path', default='D:\data\CT_MAR\CT_MAR_raw_version\CT_MAR\Test\s_res', type=str)
